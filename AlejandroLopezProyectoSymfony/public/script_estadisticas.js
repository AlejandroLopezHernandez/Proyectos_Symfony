...
document.addEventListener("DOMContentLoaded", function () { 
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const values = data.map(item => item.reproduccionesXcancion); // Valores para el gráfico (total de reproducciones)
            ...
            const ctx = document.getElementById('reproduccionesCancionChart').getContext('2d');
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(tooltipItem) {
                                    return tooltipItem.label + ': ' + tooltipItem.raw + ' reproducciones';  // Personalización de la leyenda
                                }
                            }
                        }
                    }
